 ...
 * @remarks the parameters is for developers who will touch this code in the future.
 * It signals that this version number was passed down by the user and not incremented by our library.
 *
 * @param databaseName Database name
